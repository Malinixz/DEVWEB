                ...
                <TableBody>
                    ...
                    (
                        <TableRow key={member.id}>
                            ...
                            <TableCell> <RemoveOrUpdateDialog id={id} token={token} user_id={member.id} onMemberRemovedOrUpdated={onMemberRemovedOrUpdated} is_admin={member.is_admin} /></TableCell>
                        </TableRow>
                    ))}
                </TableBody>
            </Table>
